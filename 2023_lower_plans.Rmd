...
lower_map <- mapview(filter(lower_sites,is.na(active)),col.regions="grey", layer.name="Inactive", cex = "3")+
  mapview(filter(lower_sites, active == "x"),zcol = "Site", layer.name="Active Sites", col.regions = lower_sites$color)+
