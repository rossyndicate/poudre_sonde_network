...
all_data <- read_csv(paste0(dir, "/data/sharing/budget/charges_final/charges_final_", month_select, "_", year_select,  ".csv"), show_col_types = FALSE)
...
field_summary <- read_csv(paste0(dir, "/data/sharing/budget/field_summary/field_summary_",month_select, "_", year_select,".csv"), show_col_types = FALSE)
