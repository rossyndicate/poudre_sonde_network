...
sonde_sites$Site <- factor(sonde_sites$Site , levels = c("JOEI", "CBRI", "CHD", "PFAL","LBEA", "PENN",  "SFM", "PBD", "Tamasag", "Legacy", "Lincoln","Timberline","Prospect","Boxelder", "Archery","River Bluffs", "BoxCreek", "SpringCreek"  )) 
...
map <-mapview(
  ...
  zcol = "Site",
  col.regions = c("green1","green2","green4", "green3"),
  legend = TRUE, 
...
Use this link to access our standard operations procedures doc: [Link](https://colostate-my.sharepoint.com/:w:/g/personal/mrvr_colostate_edu/EUvCdkvXF9xEhwyWT-GhOQUBaYr2IqofXv5g2ZBZh5Od1Q?e=C23Azd)
...
This section is broken down by project: Reservoir Study, PWQN and CU Collaboration
...
This site will represent the unburned control for the CU project's assessment of water quality sensors' effectiveness at measuring burn effects.

```{r PENN, echo=FALSE}
# Generate the map and table for "PENN"
get_site_map("PENN")
generate_site_table("PENN")
```

### Little Beaver Creek

![](images/LBEA_20221006__upstream.jpg){width="281"}

This site will represent the burned control for the CU project's assessment of water quality sensors' effectiveness at measuring burn effects. This site is also heavily studied by other CSU and RMRS projects.

```{r LBEA, echo=FALSE}
# Generate the map and table for "LBEA"
get_site_map("LBEA")
generate_site_table("LBEA")
```
