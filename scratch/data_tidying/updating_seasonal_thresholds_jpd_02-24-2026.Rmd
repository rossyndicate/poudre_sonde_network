...
final_thresholds <- all_combinations %>%
  ...
  mutate(
    ...
    # if t_mean_01 is less than the realistic threshold, replace with the 
    # realistic threshold. If t_mean_99 is greater than the realistic threshold, 
    # replace with the realistic threshold.
