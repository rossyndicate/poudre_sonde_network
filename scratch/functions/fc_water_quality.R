#' Import City of Fort Collins Water Quality Data
#'
#' This function pulls water quality measurements for the City of Fort Collins.
#'
#'
...
fc_water_demand <- function(start = '2018-10-01', end = Sys.Date(), save = TRUE, path = 'data/context_data/'){
  ...
  call <- "https://opendata.fcgov.com/api/views/8n27-taq6/rows.csv?accessType=DOWNLOAD"
  ...
  if(save == TRUE){
    write_csv(data, paste0(path, "/fc_water_quality.csv"))
  }
