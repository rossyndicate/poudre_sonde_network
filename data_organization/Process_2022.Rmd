...
raw_troll_legacy <- map_dfr(grep(list.files("data/raw/sensor/log_download/2022/legacy/manual/", full.names = T), pattern = "trolled", invert = F, value = T), troll_reader)
...
```{r}
# Full Dataset:
raw <- readxl::read_excel('data/raw/sensor/log_download/2022/lincoln/lincoln.xlsx')
