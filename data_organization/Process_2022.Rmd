...
legacy_depth_corrected <- all_sites %>%
  ...
  mutate(value_p1 = ifelse(value_p1 = ifelse(timestamp >= ymd_hms('2022-04-06 06:00:00') & timestamp < ymd_hms('2022-04-12 9:20:00')), 
                           value + 
                             abs(
...
timberline_depth_corrected <- all_sites %>%
  ...
  mutate(value_p1 = ifelse(timestamp >= ymd_hms('2022-04-06 08:00:00') & timestamp < ymd_hms('2022-04-07 17:14:00') & ymd_hms('2022-04-07 16:56:00'), 
                           value + 
                             abs(
