...
```{r}
# KW added this for testing. Could not find how this object was originally created.
temperature_archery_field_flags <- all_data_summary_stats_list[["archery-Temperature"]] %>%
  add_field_flags()

# KW's end of the road - can't find `add_sensor_spec_range_flags()` dev in workflow
