...
add_large_anomaly_flag <- function(df) {
  ...
  df <- df %>% 
    ...
    mutate(flag_binary = ifelse((is.na(flag) | str_detect(flag, "^(24hr anomaly|anomaly window|24hr anomaly;\\nanomaly window)$")), 0, 1),
...
# weekly_daily_flag_plots("archery", "Actual Conductivity", "seasonal range")
```
