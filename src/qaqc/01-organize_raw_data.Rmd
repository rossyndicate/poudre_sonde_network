...
generate_weekly_flag_plots("prospect", "Temperature", "slope flag suspect")
```
...
generate_seasonal_histogram <- function(df) {
  ...
  summer <- c(6,7,8)
  fall <- c(9,10,11)
  seasons <- data.frame(winter, spring, summer, fall)
...
generate_seasonal_histograms(df=all_data_flagged[["archery-Temperature"]])
```
