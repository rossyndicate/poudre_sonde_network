...
# generate_daily_flag_plots("archery", "Temperature", "missing data", df_list = all_data_flagged)
```

Visualizing weekly plots
```{r, fig.width=12, fig.height=7}
# generate_weekly_flag_plots("archery", "Temperature", "slope violation", df_list = all_data_flagged)
```

Stack the weekly and daily plots
```{r, fig.width=12, fig.height=12}
# stack_flag_plots("archery", "Temperature", "missing data", all_data_flagged)
```
...
```{r}
all_data <- all_data_flagged %>% bind_rows() %>%
