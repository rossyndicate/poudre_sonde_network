...
sapply(list.files("src/explore_and_fix_fxs/verification_functions", pattern = "*.R", full.names = TRUE), source, .GlobalEnv)

sapply(list.files("src/explore_and_fix_fxs/plotting_functions", pattern = "*.R", full.names = TRUE), source, .GlobalEnv)
```
