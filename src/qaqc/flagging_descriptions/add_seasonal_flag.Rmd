...
slope_violation_plots <- stack_flag_plots("timberline", "Temperature", "slope violation", slope_violation_data)
...
# pull in
summary_data <- readRDS('data/summary_stats/all_data_summary_stats_list.RDS')
summary_data_flagged <- map(summary_data, add_seasonal_flag)
# explore
slope_violation_plots1 <- stack_flag_plots("timberline", "Turbidity", "slope violation", summary_data_flagged)
slope_violation_plots1
slope_violation_plots2 <- stack_flag_plots("timberline", "Temperature", "slope violation", summary_data_flagged)
slope_violation_plots2
# good example
example_plot_good <- slope_violation_plots1[[14]]
ggsave(filename = 'data/QAQC_images/flag_examples/range_good_example.png',
       plot = example_plot_good,
       height = 8, width = 10)
# bad examples
example_plot_bad <- slope_violation_plots2[[9]]
ggsave(filename = 'data/QAQC_images/flag_examples/range_bad_example.png',
       plot = example_plot_bad,
       height = 8, width = 10)
```
...
### Good
![Example of slope violation flag working properly](../../../data/QAQC_images/flag_examples/range_good_example.png)

- This point is flagged for a slope violation.
- This point would not have been capture by the sd or range limit flag. 

### Bad
![Example of slope violation flag working properly](../../../data/QAQC_images/flag_examples/range_bad_example.png)
