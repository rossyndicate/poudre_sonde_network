...
saveRDS(final_flag, 'data/flagged/all_data_flagged_new.RDS')

write_feather(final_flag %>% bind_rows(), 'data/flagged/all_data_flagged_new.feather')
```
