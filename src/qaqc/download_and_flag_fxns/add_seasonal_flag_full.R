...
add_seasonal_flag_full <- function(df) {
...
# I put this and the original into a diff checker and could not find any meaningful differences
# Find where this one is used and replace it with the original so that we don't have duplicates
