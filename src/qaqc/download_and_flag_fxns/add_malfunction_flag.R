...
add_malfunction_flag <- function(df){
  ...
  df <- df %>%
    ...
    ## 2023
    add_flag((year == "2023" & DT_round >= "2023-09-13 11:00:00" & DT_round <= "2023-09-15 16:00:00" & site == "legacy"), "sensor malfunction") %>%
    add_flag((year == "2023" & DT_round >= "2023-09-19 16:00:00" & DT_round <= "2023-09-22 08:00:00" & site == "legacy"), "sensor malfunction") %>%

    # LINCOLN
    ## 2023
    add_flag((year == "2023" & DT_round >= "2023-09-01 10:00:00" & DT_round <= "2023-09-15 12:00:00" & site == "lincoln" & parameter == "Turbidity"), "sensor malfunction") %>%
    ...
    add_flag((year == "2023" & DT_round >= "2023-04-24 15:00:00" & DT_round <= "2023-04-27 17:00:00" & site == "timberline" & parameter == "Turbidity"), "sensor malfunction") %>%
    ### wiper issue, affects cond sensor adds extra noise to data
    add_flag((year == "2023" & DT_round >= "2023-05-31 9:00:00" & DT_round <= "2023-06-26 12:40:00" & site == "timberline" & parameter %in% c("Actual Conductivity", "Specific Conductivity")), "sensor malfunction") %>%
    add_flag((year == "2023" & DT_round >= "2023-07-14 20:00:00" & DT_round <= "2023-07-16 2:00:00" & site == "timberline" & parameter %in% c("Actual Conductivity", "Specific Conductivity")), "sensor malfunction") %>%
    ### housing filled with sediment post storm, sensor caked in sediment
    add_flag((year == "2023" & DT_round >= "2023-07-22 11:30:00" & DT_round <= "2023-07-24 11:30:00" & site == "timberline" & parameter == "Turbidity"), "sensor malfunction") %>%
    ...
    ## 2023
    add_flag((year == "2023" & DT_round >= "2023-07-31 19:00:00" & DT_round <= "2023-08-04 13:00:00" & site == "boxelder"), "sensor malfunction") %>%
    ...
    ## 2023
    add_flag((year == "2023" & DT_round >= "2023-04-11 09:45:00" & DT_round <= "2023-04-11 10:15:00" & site == "archery"), "sensor malfunction") %>%
    add_flag((year == "2023" & DT_round >= "2023-07-17 05:00:00" & DT_round <= "2023-07-19 14:45:00" & site == "archery"), "sensor malfunction") %>%
    add_flag((year == "2023" & DT_round >= "2023-09-12 06:30:00" & DT_round <= "2023-09-15 09:30:00" & site == "archery"), "sensor malfunction") %>%
    add_flag((year == "2023" & DT_round >= "2023-09-15 09:15:00" & DT_round <= "2023-10-16 01:30:00" & site == "archery" & parameter == "Actual Conductivity"), "sensor malfunction") %>%
    ...
    add_flag((year == "2023" & DT_round >= "2023-05-04 12:00:00" & DT_round <= "2023-07-05 22:00:00" & site == "riverbluffs"), "sensor malfunction") %>%
    add_flag((year == "2023" & DT_round >= "2023-07-27 01:00:00" & DT_round <= "2023-08-03 08:00:00" & site == "riverbluffs"), "sensor malfunction") %>%


    # TAMASAG
    ## 2023
    ### turb calibration issue
    add_flag((year == "2023" & DT_round >= "2023-05-15 11:20:00" & DT_round <= "2023-05-15 18:00:00" & site == "tamasag" & parameter == "Turbidity"), "sensor malfunction") %>%
    ### turb moisture under lens
    add_flag((year == "2023" & DT_round >= "2023-06-13 04:00:00" & DT_round <= "2023-06-26 12:40:00" & site == "tamasag" & parameter == "Turbidity"), "sensor malfunction")
