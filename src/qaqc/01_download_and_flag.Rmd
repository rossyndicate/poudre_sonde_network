...
# reading this in so it works for our add_spec_flag function, but this will change
...
# saveRDS(all_data_flagged %>% bind_rows(), 'data/flagged/all_data_flagged_bound.RDS')
